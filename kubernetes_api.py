...
class KubernetesAPI:
    ...
    def __init__(self, namespace='ervin', app_name='postgres'):
        self.namespace = namespace
        self.app_name=app_name
        config.load_kube_config()


    def create_deployment(self, yaml_file = "postgres-deployment.yaml"):
    ...
    def delete_deployment(self):
        try:
            k8s_apps_v1 = client.ExtensionsV1beta1Api()
            resp = k8s_apps_v1.delete_namespaced_deployment(self.app_name, self.namespace)
    ...
    def delete_everything(self):
        ...
        label_selector = f'app={self.app_name}' # str | A selector to restrict the list of returned objects by their labels. Defaults to everything. (optional)
